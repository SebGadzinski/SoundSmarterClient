...
#Info
echo "[!] This script is for publishing the quasar vue project as a Capacitor Web App"
...
echo "[!] Ensure you have nginx set up correctly to the /srv/www-data/Sound-Smarter/app path."
#!/bin/bash
...
START_DIR=$PWD
BUILD_DIR_SRC="src-capacitor/www"
BUILD_DIR_STATIC_SRC="/home/user/Sound-Smarter/Client-Details"
BUILD_DIR_DEST="/srv/www-data/Sound-Smarter/app"
USERNAME="$SUDO_USER"
