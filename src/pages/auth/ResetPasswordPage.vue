<template>
	<div class="column">
		<q-form class="form-class" name="Reset Password" @submit.prevent="handleResetPassword">
			<q-input v-model="newPassword" type="password" :label="$t('New Password')"
				:rules="[(val) => !!val || $t('Password is required')]" :dense="false" />
			<q-input v-model="confirmPassword" type="password" :label="$t('Confirm Password')"
				@blur="confirmPasswordTouched = true" :rules="[
